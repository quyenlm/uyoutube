...
//            channelRequest.setMine(true);
            ...
            if (channelsList != null) {
                ...
                if (newActivityInserted != null) {
                    ...
                    System.out.println(newActivityInserted.getSnippet().getTitle());
                    System.out.println(newActivityInserted.getSnippet().getDescription());

                    System.out.println(newActivityInserted.getSnippet().getChannelId() + newActivityInserted.getSnippet().getChannelTitle());
